...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.supervisor.user.home', compact('users'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.supervisor.user.create', compact('branches'));
    }
    ...
    {
        $branches = Branch::where('branch', '!=', 'Indonesia')->get();
        return view('dashboard.supervisor.user.edit', compact('user', 'branches'));
    }

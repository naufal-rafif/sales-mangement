                    ...
                    <div class="row mb-5">
                        <div class="col-lg-12 position-relative">
                            <div class="p-3 position-absolute">
                                <a class="btn btn-primary" href="{{ route('superadmin.user') }}"><i class="bx bx-arrow-back"></i> Back</a>
                            </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select mb-3" name="role" aria-label="Default select example">
                                            <option value="0" {{ $user->type == 'superadmin' ? 'selected' : ''}}>Superadmin</option>
                                            <option value="1" {{ $user->type == 'supervisor' ? 'selected' : ''}}>Supervisor</option>
